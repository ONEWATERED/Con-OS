...
export const CompanySettings: React.FC<CompanySettingsProps> = ({ settings, onSave, onBack }) => {
  ...
  const inputClass = "w-full px-3 py-2 bg-white border border-border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary";
