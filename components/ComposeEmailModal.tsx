...
export const ComposeEmail: React.FC<ComposeEmailProps> = ({ project, companySettings, onClose, onSendEmail }) => {
    ...
    const inputClass = "w-full px-3 py-2 bg-transparent border-b border-border focus:outline-none focus:border-blue-500";
    
    return (
        <div className="fixed bottom-0 right-8 bg-card rounded-t-lg shadow-2xl w-full max-w-xl h-[500px] flex flex-col z-20 border border-border">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col flex-grow overflow-hidden">
                ...
                <textarea 
                    ...
                    className="flex-grow p-3 w-full border-none focus:ring-0 text-sm" 
