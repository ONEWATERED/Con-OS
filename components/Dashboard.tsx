...
export const Dashboard: React.FC<DashboardProps> = ({ projects, onSelectProject, onNewProject, onGoToSettings, onLoadSampleData }) => {
  return (
    <div className="max-w-5xl mx-auto">
        ...
        <div className="flex items-center space-x-4">
           <button
            ...
            <button
              ...
              className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-lg shadow-sm text-black bg-primary hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary"
            >
      ...
      {projects.length === 0 ? (
        <div className="text-center py-20 px-6 bg-card rounded-xl shadow-sm border border-border">
          ...
          <h2 className="mt-4 text-2xl font-semibold text-text-default">Welcome!</h2>
          <p className="mt-2 text-text-muted">
            Create your first project or load a sample project to explore the features.
          </p>
