        ...
        <div className="bg-card p-6 rounded-xl shadow-sm border border-border space-y-6">
            <div className="flex justify-between items-center">
                ...
                <div className="flex items-center space-x-2">
                    <button onClick={() => setIsAlbumModalOpen(true)} className="px-4 py-2 text-sm font-semibold bg-gray-200 rounded-lg">New Album</button>
            ...
            {isAlbumModalOpen && (
                 <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
                    <div className="bg-card rounded-xl shadow-2xl p-6 w-full max-w-sm">
                        ...
                        <input type="text" value={newAlbumName} onChange={e => setNewAlbumName(e.target.value)} className="w-full p-2 border border-border rounded-md" placeholder="Album name..." />
                        <div className="mt-4 flex justify-end space-x-2">
                            <button onClick={() => setIsAlbumModalOpen(false)} className="px-4 py-2 text-sm font-semibold bg-gray-200 rounded-lg">Cancel</button>
