        ...
        <div className="max-w-4xl mx-auto space-y-6">
            ...
            {projectContacts.length === 0 ? (
                <div className="text-center py-16 px-6 bg-card rounded-xl shadow-sm border border-border">
                    ...
                    <h2 className="mt-4 text-xl font-semibold text-text-default">No contacts assigned to this project.</h2>
                    <p className="mt-2 text-text-muted">Click "Add from CRM" to assign stakeholders to this project.</p>
                </div>
            ) : (
