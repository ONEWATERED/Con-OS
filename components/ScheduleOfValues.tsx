    ...
    <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-card rounded-xl shadow-sm border border-border overflow-hidden">
             <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-border text-sm">
                    ...
                    <tfoot className="bg-gray-100">
                        <tr>
                            <td colSpan={2} className="px-3 py-3 text-right font-bold text-text-default uppercase">Original Contract Sum</td>
                            <td className="px-3 py-3 text-right font-bold text-text-default text-base">{formatCurrency(originalContractSum)}</td>
                            <td></td>
                        </tr>
                    </tfoot>
                </table>
             ...
             <div className="p-4 border-t border-border">
                <button onClick={handleAddLineItem} className="px-3 py-1.5 text-sm font-medium bg-primary-light/80 hover:bg-primary-light rounded-md">
                    Add Line Item
                </button>
            </div>
        </div>
