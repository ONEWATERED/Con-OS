                ...
                <SectionHeader title="Details" sectionKey="details" />
                 {openSections.details && (
                     <div className="mt-4 grid grid-cols-2 gap-4">
                        ...
                        <div className="col-span-2"><FormField label="Description"><textarea name="description" value={sub.description} onChange={handleBasicChange} rows={4} className={inputClass}></textarea></FormField></div>
