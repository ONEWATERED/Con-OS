                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                     ...
                     <div>
                        ...
                        <textarea name="notes" onChange={handleChange} value={formData.notes} className={inputClass} rows={3}></textarea>
                    </div>
        ...
        <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div className="flex justify-between items-center">
                ...
                <div className="flex space-x-2">
                    <button onClick={() => setIsModalOpen(true)} className="px-4 py-2 text-sm font-semibold bg-gray-200 rounded-lg">Log Manual Test</button>
                        ...
                        <tbody className="bg-white divide-y divide-border">
                            {sortedTests.map(test => (
                                <tr key={test.id} className="hover:bg-gray-50">
                                    <td className="px-4 py-3 font-semibold text-text-default">{test.name}</td>
                                    ...
                                    <td className="px-4 py-3">{test.notes}</td>
